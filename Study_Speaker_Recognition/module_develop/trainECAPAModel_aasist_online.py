...
from tools import *
from dataLoader_aasist_online import train_loader
from ECAPAModel_aasist_online import ECAPAModel

parser = argparse.ArgumentParser(description = "ECAPA_trainer")
## Training Settings
parser.add_argument('--num_frames', type=int,   default=200,     help='Duration of the input segments, eg: 200 for 2 second')
parser.add_argument('--max_epoch',  type=int,   default=80,      help='Maximum number of epochs')
parser.add_argument('--batch_size', type=int,   default=200,     help='Batch size')   # 400
...
parser.add_argument('--save_path',  type=str,   default="exps/299sample_online_10eval_aasist_lr001_ep80_ti",                                     help='Path to save the score.txt and models')
