...
parser.add_argument('--train_list', type=str,   default="/Data1/VoxCeleb/VoxCeleb2/Audio/train_list_299_speed_noise_msg.txt",     help='The path of the training list, eg:"/data08/VoxCeleb2/train_list.txt" in my case, which contains 1030842 lins')
...
parser.add_argument('--save_path',  type=str,   default="exps/299sample_speed_noise_offline_10eval_msg_cnn_origin_cfw_fa_module_ti",                                     help='Path to save the score.txt and models')
