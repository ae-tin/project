...
from ECAPAModel_es import ECAPAModel
...
parser.add_argument('--save_path',  type=str,   default="exps/299sample_offline_10eval_msg_es_tf10_2_ti3",                                     help='Path to save the score.txt and models')
