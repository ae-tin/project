...
parser.add_argument('--train_list', type=str,   default="/Data1/VoxCeleb/VoxCeleb2/Audio/train_list.txt",     help='The path of the training list, contains 171807 lins')
...
parser.add_argument('--eval_list',  type=str,   default="/Data1/VoxCeleb/VoxCeleb2/Audio/veri_test2.txt",              help='The path of the evaluation list, veri_test2.txt comes from https://www.robots.ox.ac.uk/~vgg/data/voxceleb/meta/veri_test2.txt,eval_list_10.txt')
...
parser.add_argument('--save_path',  type=str,   default="exps/full_data_offline_msg_cnn_origin_cfw_fa_module_ti",                                     help='Path to save the score.txt and models')
...
while(1):
	...
	if epoch <= 5 :
		for name in s.state_dict() :
			if ('.weight.' in name) and (name.endswith('.weight')) :
				print('********* weight ******** : ')
