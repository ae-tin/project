...
from ECAPAModel_aasist import ECAPAModel
...
parser.add_argument('--save_path',  type=str,   default="exps/299sample_offline_10eval_msg_aasist_lr01_ep1000_ti",                                     help='Path to save the score.txt and models')
