...
parser.add_argument('--csv_path',  type=str,   default='/Data2/folder_ti/data/1st_1010_train.csv', help='Path to save the score.txt and models')
parser.add_argument('--save_path',  type=str,   default="exps/first_classification/tabnet_final_score.txt", help='Path to save the score.txt and models')
