...
parser.add_argument('--save_path',  type=str,   default="exps/first_classification/smote_final_xgboost_grid_score.txt", help='Path to save the score.txt and models')
...
for j in tqdm(range(200)):
    ...
    for i in range(2):
        ...
        clf.fit(X_train_over, y_train_over)#,evals = (X_valid,y_valid))
