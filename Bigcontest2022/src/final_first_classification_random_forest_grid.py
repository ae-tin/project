...
parser.add_argument('--save_path',  type=str,   default="exps/first_classification/final_random_forest_grid_score.txt", help='Path to save the score.txt and models')
