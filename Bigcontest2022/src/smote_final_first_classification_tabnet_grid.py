...
parser.add_argument('--save_path',  type=str,   default="exps/first_classification/smote_final_tabnet_grid_score.txt", help='Path to save the score.txt and models')
...
for j in tqdm(range(200)):
    ...
    params = {'n_d' : np.random.choice([4,16,64]),
             ...
             'n_steps' :np.random.choice([3,5,6,7]),        # tree에 depth
