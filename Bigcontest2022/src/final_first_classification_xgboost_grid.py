...
parser.add_argument('--save_path',  type=str,   default="exps/first_classification/final_xgboost_grid_score.txt", help='Path to save the score.txt and models')
...
for j in tqdm(range(200)):
    ...
    for i in range(2):
        ...
        start = time.time()
        clf.fit(X_train, y_train)#,evals = (X_valid,y_valid))
