...
logging.basicConfig(filename='/Data2/dacon/model_ti/submission2/log/train.log', level=logging.DEBUG)
...
gen_dataset_tmp_path = '/Data2/dacon/model_ti/submission2/output/output_generation_week/gen_dataset_tmp_'+str(epoch)+'.csv'
...
data = pd.read_csv(best_case_per_week_path)
...
for fea in aug_feature : 
    ...
    signal_shape = 24
    latent_space_dim = 20
    encoder_path = '/Data2/dacon/model_ti/submission2/model/generation_week/epoch'+str(epoch)+'/encoder_' + fea + '.pt'
    decoder_path = '/Data2/dacon/model_ti/submission2/model/generation_week/epoch'+str(epoch)+'/decoder_' + fea + '.pt'
    critic_x_path = '/Data2/dacon/model_ti/submission2/model/generation_week/epoch'+str(epoch)+'/critic_x_' + fea + '.pt'
    critic_z_path = '/Data2/dacon/model_ti/submission2/model/generation_week/epoch'+str(epoch)+'/critic_z_' + fea + '.pt'
